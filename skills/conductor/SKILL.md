...
Coder(opus)→Auditor(sonnet), Writer(opus)→Reviewer(sonnet+external reviewer CLI), Engineer(opus)→Auditor(sonnet). Same model NEVER produces+reviews.
